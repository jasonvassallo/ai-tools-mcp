...
Expect the call to take one to several minutes. Present the agent's answer with citations preserved verbatim, report the cost figure from the metadata footer, and surface any sandbox execution warnings rather than hiding them.
